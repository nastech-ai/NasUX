...
/**
 * Portuguese (Brazilian) translations for the NasTech app
...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'NasTech é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/nastech-ai/nastech/issues se você atingir este limite.',
    ...
    server: {
        ...
        notValidNasTechServer: 'Não é um servidor NasTech válido',
    ...
    sessionInfo: {
        ...
        nastechSessionIdCopied: 'ID da sessão NasTech copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão NasTech',
        nastechSessionId: 'ID da sessão NasTech',
        ...
        updateCliInstructions: 'Por favor execute pip install -U nastech-agent',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta NasTech. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `nastech daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `pip install -U nastech-agent`',
