...
/**
 * Spanish translations for the NasTech app
...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'NasTech es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has alcanzado el número máximo de conversaciones de voz este mes. Es posible que en el futuro agreguemos uso de voz bajo demanda — por favor crea un issue en github.com/nastech-ai/nastech/issues si alcanzas este límite.',
    ...
    server: {
        ...
        notValidNasTechServer: 'No es un servidor NasTech válido',
    ...
    sessionInfo: {
        ...
        nastechSessionIdCopied: 'ID de sesión de NasTech copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de NasTech',
        nastechSessionId: 'ID de sesión de NasTech',
        ...
        nastechHome: 'Directorio de NasTech',
        ...
        updateCliInstructions: 'Por favor ejecute pip install -U nastech-agent',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de NasTech. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `nastech daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `pip install -U nastech-agent`',
