...
public class Am extends BaseCommand {
        ...
        do {
            ...
            try {
                ...
                out.println("Error: Activity class " +
                        intent.getComponent().toShortString() + " does not exist.");
            } catch (Exception e) {
    ...
    private void sendBroadcast() throws Exception {
        ...
        app.sendOrderedBroadcast(intent, mReceiverPermission, receiver,
                new Handler(app.getMainLooper()), Activity.RESULT_OK, null, null);
