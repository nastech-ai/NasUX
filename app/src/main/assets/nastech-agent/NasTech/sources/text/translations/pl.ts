...
/**
 * Polish translations for the NasTech app
...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'NasTech to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Osiągnąłeś maksymalną liczbę rozmów głosowych w tym miesiącu. Możliwe, że w przyszłości dodamy głosowe korzystanie na żądanie — prosimy o zgłoszenie na github.com/nastech-ai/nastech/issues, jeśli napotkasz ten limit.',
    ...
    server: {
        ...
        notValidNasTechServer: 'To nie jest prawidłowy serwer NasTech',
    ...
    sessionInfo: {
        ...
        nastechSessionIdCopied: 'ID sesji NasTech skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji NasTech',
        nastechSessionId: 'ID sesji NasTech',
        ...
        nastechHome: 'Katalog domowy NasTech',
        ...
        updateCliInstructions: 'Proszę uruchomić pip install -U nastech-agent',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem NasTech. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `nastech daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `pip install -U nastech-agent`',
