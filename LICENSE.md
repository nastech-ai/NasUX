The `nastech-ai/NasTech-Agent` repository is released under [GPLv3 only](https://www.gnu.org/licenses/gpl-3.0.html) license.
...
- Check [`nasux-shared/LICENSE.md`](nasux-shared/LICENSE.md) for `nasux-shared` library related exceptions.
