 ...
 *
 * - 0.2.0 (2021-03-11)
 *      - Renamed `HOME_PATH` to `NASUX_HOME_DIR_PATH`.
 *      - Renamed `NASUX_PROPERTIES_PRIMARY_PATH` to `NASUX_PROPERTIES_PRIMARY_FILE_PATH`.
 *      - Renamed `NASUX_PROPERTIES_SECONDARY_FILE_PATH` to `NASUX_PROPERTIES_SECONDARY_FILE_PATH`.
 *
 * - 0.3.0 (2021-03-16)
 ...
 *
 * - 0.14.0 (2021-09-02)
 *      - Add `getNasUXFloatPropertiesFile()`.
 *
 * - 0.15.0 (2021-09-05)
...
/**
 * A class that defines shared constants of the SharedProperties used by NasUX app and its plugins.
 ...
 * {@link NasUXConstants#NASUX_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link NasUXConstants#NASUX_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class NasUXPropertyConstants {

    private static final String LOG_TAG = "NasUXPropertyConstants";
    ...
    /** Defines the key for whether to hide soft keyboard when nasux app is started */
    ...
    /** Defines the key for whether the {@link NasUXAmSocketServer} should be run at app startup */
    public static final String KEY_RUN_NASUX_AM_SOCKET_SERVER =  "run-nasux-am-socket-server"; // Default: "run-nasux-am-socket-server"
     ...
     * deleted from $TMPDIR on nasux exit.
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = NasUXConstants.NASUX_HOME_DIR_PATH;
    ...
    /** Defines the set for keys loaded by nasux
     * Setting this to {@code null} will make {@link SharedProperties} throw an exception.
     * */
    public static final Set<String> NASUX_APP_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        /* boolean */
        ...
        KEY_RUN_NASUX_AM_SOCKET_SERVER,
        KEY_TERMINAL_ONCLICK_URL_OPEN,
        KEY_USE_CTRL_SPACE_WORKAROUND,
        KEY_USE_FULLSCREEN,
        KEY_USE_FULLSCREEN_WORKAROUND,
        NasUXConstants.PROP_ALLOW_EXTERNAL_APPS,
    ...
    /** Defines the set for keys loaded by nasux that have default boolean behaviour with false as default.
     * "true" -> true
     * "false" -> false
     * default: false
     */
    public static final Set<String> NASUX_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_DISABLE_FILE_SHARE_RECEIVER,
        KEY_DISABLE_FILE_VIEW_RECEIVER,
        KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS,
        KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST,
    ...
    /** Defines the set for keys loaded by nasux that have default boolean behaviour with true as default.
     * "true" -> true
     * "false" -> false
     * default: true
     */
    public static final Set<String> NASUX_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_EXTRA_KEYS_TEXT_ALL_CAPS,
        KEY_RUN_NASUX_AM_SOCKET_SERVER
    ));

    /** Defines the set for keys loaded by nasux that have default inverted boolean behaviour with false as default.
     * "false" -> true
     * "true" -> false
     * default: false
     */
    public static final Set<String> NASUX_DEFAULT_INVERETED_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));

    /** Defines the set for keys loaded by nasux that have default inverted boolean behaviour with true as default.
     * "false" -> true
     * "true" -> false
     * default: true
     */
    public static final Set<String> NASUX_DEFAULT_INVERETED_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));
