        ...
        const startQRAuth = async () => {
            try {
                ...
                if (credentials && !isCancelledRef.current) {
                    // secret is already a string token from AuthCredentials
                    const secretString = credentials.secret;
            ...
            <View style={styles.container}>
                ...
                <View style={{justifyContent: 'flex-end' }}>
                    <Text style={styles.secondInstructionText}>
                        1. Open NasTech on your mobile device{'\n'}
                ...
                {authReady && (
                    <QRCode
                        data={'nastech:///account?' + encodeBase64(keypair.publicKey, 'base64url')}
                        size={300}
