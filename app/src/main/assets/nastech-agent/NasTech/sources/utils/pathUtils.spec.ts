...
describe('pathUtils', () => {
    ...
    describe('resolvePath (existing function)', () => {
        ...
        it('should not resolve sibling directory paths that start with metadata path', () => {
            const metadata = {
                path: '/Users/steve/Develop/nastech-ai/nastech',
                host: 'localhost',
                homeDir: '/Users/steve'
            };
            // This should NOT be resolved as it's a sibling directory, not within the metadata path
            expect(resolvePath('/Users/steve/Develop/nastech-ai/nastech-server/sources/types/index.ts', metadata))
                .toBe('/Users/steve/Develop/nastech-ai/nastech-server/sources/types/index.ts');
        });
    ...
    describe('integration scenarios', () => {
        it('should work with typical macOS home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/nastech', homeDir)).toBe('/Users/developer/Projects/nastech');
        ...
        it('should work with typical Linux home directories', () => {
            ...
            expect(resolveAbsolutePath('~/projects/nastech', homeDir)).toBe('/home/developer/projects/nastech');
        ...
        it('should work with typical Windows home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/nastech', homeDir)).toBe('C:\Users\developer\Projects/nastech');
