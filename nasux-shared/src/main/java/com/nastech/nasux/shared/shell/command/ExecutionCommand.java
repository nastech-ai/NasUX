package com.nastech.nasux.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the NasUX app
    perspective.
    */
     ...
     * commands. By default, @link com.nastech.nasux.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the NasUX plugin API that was used to start the
     ...
     * like with an intent or from within NasUX app itself. */
