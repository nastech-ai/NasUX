package com.nastech.nasux.app.fragments.settings.nasux_tasker;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.nasux_tasker_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            NasUXTaskerAppSharedPreferences preferences = NasUXTaskerAppSharedPreferences.build(context, true);
            if (preferences == null) return;

            com.nastech.nasux.app.fragments.settings.nasux.DebuggingPreferencesFragment.
