...
/**
 * Work around for fullscreen mode in NasUX to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(NasUXActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(NasUXActivity activity) {
