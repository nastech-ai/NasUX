 ...
 *          NasUX app and its plugins. This will allow {@link com.nastech.nasux.app.NasUXSettings} to
 ...
 *      - Added following to `NASUX_TASKER_APP`:
 *           `KEY_LOG_LEVEL`.
 *
 * - 0.4.0 (2021-03-13)
 *      - Added following to `NASUX_APP`:
 ...
 *
 * - 0.6.0 (2021-03-24)
 *      - Change `DEFAULT_VALUE_KEEP_SCREEN_ON` value to `false` in `NASUX_APP`.
 *
 * - 0.7.0 (2021-03-27)
 *      - Added following to `NASUX_APP`:
 ...
 *
 * - 0.12.0 (2021-08-27)
 *      - Added `NASUX_API_APP.KEY_LOG_LEVEL`, `NASUX_BOOT_APP.KEY_LOG_LEVEL`,
 *          `NASUX_FLOAT_APP.KEY_LOG_LEVEL`, `NASUX_STYLING_APP.KEY_LOG_LEVEL`,
 *          `NASUX_Widget_APP.KEY_LOG_LEVEL`.
 *
 * - 0.13.0 (2021-09-02)
 *      - Added following to `NASUX_FLOAT_APP`:
 *          `KEY_WINDOW_X`, `KEY_WINDOW_Y`, `KEY_WINDOW_WIDTH`, `KEY_WINDOW_HEIGHT`, `KEY_FONTSIZE`,
 *          `KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED`.
 *
 * - 0.14.0 (2021-09-04)
 *      - Added `NASUX_WIDGET_APP.KEY_TOKEN`.
 *
 * - 0.15.0 (2021-09-05)
 *      - Added following to `NASUX_TASKER_APP`:
...
/**
 * A class that defines shared constants of the SharedPreferences used by NasUX app and its plugins.
 ...
 */
public final class NasUXPreferenceConstants {
    ...
    public static final class NASUX_APP {
        ...
        /**
         * Defines the key for font size of nasux terminal view.
         */
        public static final String KEY_FONTSIZE = "fontsize";


        /**
         * Defines the key for current nasux terminal session.
         */
        ...
        /**
         * The {@link ExecutionCommand.Runner#APP_SHELL} number after nasux app process since boot.
         */
        ...
        /**
         * The {@link ExecutionCommand.Runner#TERMINAL_SESSION} number after nasux app process since boot.
         */
        ...
        /**
         * Defines the key for whether nasux terminal view key logging is enabled or not
         */
