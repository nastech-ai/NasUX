package com.nastech.nasux.view;
...
import com.nastech.nasux.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                ...
                // https://github.com/nasux/nasux-app/issues/686
                ...
                // https://github.com/nasux/nasux-packages/issues/25
                // https://github.com/nasux/nasux-app/issues/87.
                // https://github.com/nasux/nasux-app/issues/126.
                // https://github.com/nasux/nasux-app/issues/137 (japanese chars and TYPE_NULL).
        ...
        // keyboard on Android TV (see https://github.com/nasux/nasux-app/issues/221).
     ...
     * https://github.com/nasux/nasux-app/pull/2237
     * https://github.com/agnostic-apollo/nasux-app/blob/terminal-code-point-custom-mapping/terminal-view/src/main/java/com/nasux/view/TerminalView.java
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // https://github.com/nasux/nasux-app/issues/731
     ...
     * {@link com.nastech.nasux.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.nastech.nasux.app.NasUXActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
