...
/**
 * Italian translations for the NasTech app
...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'NasTech è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Hai raggiunto il numero massimo di conversazioni vocali questo mese. Potremmo aggiungere l\'uso vocale su richiesta in futuro — per favore apri un issue su github.com/nastech-ai/nastech/issues se raggiungi questo limite.',
    ...
    server: {
        ...
        notValidNasTechServer: 'Non è un NasTech Server valido',
    ...
    sessionInfo: {
        ...
        nastechSessionIdCopied: 'ID sessione NasTech copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione NasTech',
        nastechSessionId: 'ID sessione NasTech',
        ...
        updateCliInstructions: 'Esegui pip install -U nastech-agent',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account NasTech. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `nastech daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `pip install -U nastech-agent`',
        daemon: 'Daemon',
        status: 'Stato',
