...
/**
 * Catalan translations for the NasTech app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'NasTech és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has assolit el nombre màxim de converses de veu aquest mes. És possible que en el futur afegim ús de veu sota demanda — si us plau, crea un issue a github.com/nastech-ai/nastech/issues si arribes a aquest límit.',
    ...
    server: {
        ...
        notValidNasTechServer: 'No és un servidor NasTech vàlid',
    ...
    sessionInfo: {
        ...
        nastechSessionIdCopied: 'ID de la sessió de NasTech copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de NasTech',
        nastechSessionId: 'ID de la sessió de NasTech',
        ...
        nastechHome: 'Directori de NasTech',
        ...
        updateCliInstructions: 'Si us plau executeu pip install -U nastech-agent',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de NasTech. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `nastech daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `pip install -U nastech-agent`',
