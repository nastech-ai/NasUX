...
public class NasUXShellManager {

    private static NasUXShellManager shellManager;
    ...
    /**
     * The foreground NasUXSessions which this service manages.
     * Note that this list is observed by an activity, like NasUXActivity.mNasUXSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<NasUXSession> mNasUXSessions = new ArrayList<>();

    /**
     * The background NasUXTasks which this service manages.
     */
    public final List<AppShell> mNasUXTasks = new ArrayList<>();
    ...
    public NasUXShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link NasUXShellManager}.
     */
    public static NasUXShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new NasUXShellManager(context);
     ...
     * @return Returns the {@link NasUXShellManager}.
     */
    public static NasUXShellManager getShellManager() {
        return shellManager;
    }
