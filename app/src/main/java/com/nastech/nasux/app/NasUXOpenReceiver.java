...
public class NasUXOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "NasUXOpenReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Uri uriToShare = UriUtils.getContentUri(NasUXConstants.NASUX_FILE_SHARE_URI_AUTHORITY, fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        private static final String LOG_TAG = "NasUXContentProvider";
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(NasUXConstants.NASUX_FILES_DIR_PATH) || path.startsWith(storagePath))) {
                    throw new IllegalArgumentException("Invalid path: " + path);
                }

                // If NasUXConstants.PROP_ALLOW_EXTERNAL_APPS property to not set to "true", then throw exception
                String errmsg = NasUXPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(getContext(), LOG_TAG);
                if (errmsg != null) {
                ...
                // NasUXConstants.PROP_ALLOW_EXTERNAL_APPS set by users without their explicit consent.
                if (NasUXConstants.NASUX_PROPERTIES_FILE_PATHS_LIST.contains(path) ||
                    NasUXConstants.NASUX_FLOAT_PROPERTIES_FILE_PATHS_LIST.contains(path)) {
                    mode = "r";
                }
