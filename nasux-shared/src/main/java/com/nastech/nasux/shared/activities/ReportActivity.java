package com.nastech.nasux.shared.activities;
 ...
 * {@code `<activity android:name="com.nastech.nasux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.NasUXReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.nastech.nasux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(NasUXConstants.NASUX_APP_NAME + " App Report");
        }
