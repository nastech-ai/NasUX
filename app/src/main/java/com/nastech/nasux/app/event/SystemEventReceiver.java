package com.nastech.nasux.app.event;
...
public class SystemEventReceiver extends BroadcastReceiver {
    ...
    public synchronized void onActionBootCompleted(@NonNull Context context, @NonNull Intent intent) {
        NasUXShellManager.onActionBootCompleted(context, intent);
    }

    public synchronized void onActionPackageUpdated(@NonNull Context context, @NonNull Intent intent) {
        Uri data = intent.getData();
        if (data != null && NasUXUtils.isUriDataForNasUXPluginPackage(data)) {
            ...
            if (NasUXFileUtils.isNasUXFilesDirectoryAccessible(context, false, false) == null)
                NasUXShellEnvironment.writeEnvironmentToFile(context);
        }
    }
